...
static const NSInteger _MM_SIZE = 19;

static const char* _MM[_MM_SIZE] =
{
    "B",
    "BackgroundTask",
    "ThreadDetachUseSomeLocalObject",
    "ThreadJoinInCatchBlockWhenThrowBeforeDefaultJoinCall",
    "UseThreadGuard",
    "DoBackgroundWork",
    "EditDocument",
    "NotOops",
    "NotOopsAgain",
    "UseReferenceAsParameter",
    "UseUniquePtrAsParameter",
    "SomeThreadMoveOperations",
    "ReturnTemporaryThread",
    "ReturnLocalThread",
    "FunctionCallFunctionUseThreadAsParameter",
    "FunctionUseScopedThread",
    "ProduceMultipleThreads",
    "ThreadIdEqual",
    "PrintThreadId"
};

@interface TB () <UITableViewDelegate, UITableViewDataSource>
